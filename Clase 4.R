...
f(abcdef=1, bcde1=2, bcde2=3)$a
str(f(abcdef=1, bcde1=2, bcde2=3))
#clasestr(f(abcdef=1, bcde1=2, bcde2=3))
...
match.arg(NULL,c("Male","Female"))  #sale el primer elemento de la lista
...
#clase
myplot(1:20,rnorm(20),col=5,lwd=4,type="l")
#clase
